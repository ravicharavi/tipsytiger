    ...
    // Name input handler
        ...
        document.getElementById('signInBtn').addEventListener('click', async () => {
            ...
            if (error) {
                ...
                errorEl.textContent = 'Success! Syncing your data...';
                currentUser = data.user;
                
                // Load data from Supabase first
                await loadData();
                
                // Sync existing localStorage data to Supabase if there's any
        ...
        document.getElementById('signUpBtn').addEventListener('click', async () => {
            ...
            if (error) {
                ...
                if (data.user) {
                    ...
                    errorEl.textContent = 'Account created! Syncing your data...';
                    currentUser = data.user;
        ...
        document.getElementById('signOutBtn').addEventListener('click', async () => {
            ...
            // Keep using localStorage after sign out
